    ...
    var j = function (e) {
            ...
            function va(a) {
                ...
                if (0 !== a.nTHead.getElementsByTagName("th").length) {
                    b = 0;
                    for (d = a.aoColumns.length; b < d; b++) if (c = a.aoColumns[b].nTh, c.setAttribute("role", "columnheader"), a.aoColumns[b].bSortable && (c.setAttribute("tabindex", a.iTabIndex), c.setAttribute("aria-controls", a.sTableId), c.setAttribute("class", "dataTablesSearchBox")), null !== a.aoColumns[b].sClass && i(c).addClass(a.aoColumns[b].sClass), a.aoColumns[b].sTitle != c.innerHTML) c.innerHTML = a.aoColumns[b].sTitle
                } else {
            ...
            function za(a) {
                ...
                c.attr("class", "dataTablesSearchBox");
                return d
            }
            function M(a, b, c) {
            ...
            function oa(a) {
                ...
                !a.sEmptyTable && (a.sZeroRecords && "No data found . . ." === b.sEmptyTable) && p(a, a, "sZeroRecords", "sEmptyTable");
            ...
            function ya(a) {
                ...
                i("select", g).attr("class", "dataTablesSearchBox");
                return g
            }
            function A(a) {
