            ...
            <div class="app-container" style="">
                ...
                <ul class="list-inline" style="border:  1px solid rgba(0, 0, 0, 0.125); padding: 5px;">
                    ...
                    <li class="list-inline-item">
                        <div class="form-group" style="margin-bottom: 5px;">
                            <button class="btn btn-success btn-sm btn-minimize" data-title="inactive" data-action="Active" id="btn-set-active-applicants">Set as Active</button>
                        </div>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="row d-filter-container">
                        <div class="col-md-5 d-filter-group">
                            ...
                            <div class="col-md-5 d-filter-group">
                                <div class="form-inline">
                                    ...
                                    <select data-scope="inactive" name="select-limit" class="form-control form-control-sm">
                        ...
                        <div class="col-md-5 d-filter-group">
                            <input type="search" data-scope="private" id="admin-search-applicants-inactive" class="form-control form-control-sm" name="search" placeholder="Search Applicants" style="height: 29px;">  
                        </div>
                ...
                <div class="clear-filter-box">
                    ...
                    <div class="ckb-box">
                        <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="select-all-admin-inactive-applicants">
                ...
                <div id="inactive-applicants-container" class="list-group app-container-main"> 
                    

                </div>
                <div id="inactive-app-pagination"></div>
