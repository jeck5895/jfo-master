    ...
    <section class="content">
        <div class="row">
            <div class="dashboard-job-container">
                <center><h5>SLIDERS<span id="current-tab"></span></h5></center>
                <hr>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8 offset-md-2">
                                            <form id="slider-form" action="" method="">
                                                <div class="form-group">
                                                    <label for="email" class="control-label required"><small>Company Name</small></label>
                                                    <input type="text" name="company_name" class="form-control" placeholder="" required tabindex="1" autofocus>
                                                </div>
                                                <div class="form-group">
                                                    <label for="email" class="control-label required"><small>Ad Title</small></label>
                                                    <input type="text" name="ads_title" class="form-control" placeholder="" required tabindex="2" >
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" class="form-control" name="ads_link" tabindex="5" placeholder="http://yourdomain.com" required>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                        <label for="email" class="control-label required"><small>Upload Image</small></label> 
                                                            ...
                                                            <small class="text-muted">(Image dimensions 1300 x 400)</small> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                        ...
                        <div class="tab3-content">
                            <div class="box box-widget">
                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table table-responsive no-border-top" id="slider-list-table" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="no-sort"> 
                                                <small class="header">Id</small>
                                                </th>
                                                <th class="mw-200" style="width: 15%;"><small class="header">Company Name</small></th>
                                                <th style="width: 15%;"><small class="header">Ad Title</small></th>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/admin/maintenance.js');?>"></script>